...
export default function Support() {
  ...
  const stats = [
    ...
    { icon: Star, label: "GitHub Stars", value: "2,500+", color: "text-yellow-500" },
    { icon: Coffee, label: "Lines of Code", value: "25,000+", color: "text-purple-500" },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 animate-fade-in">
            <div className="flex justify-center items-center gap-4 mb-8">
              ...
              <Heart className="h-16 w-16 text-red-500 fill-red-500 animate-bounce" style={{ animationDelay: '0.5s' }} />
            </div>
            
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Smart Budget is 100% open source and completely free. Your donations help us maintain the servers, 
              add new features, and keep this powerful financial tool accessible to everyone worldwide.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            {stats.map((stat, index) => (
              <Card key={stat.label} className="glass-card border-0 shadow-premium text-center group hover:scale-105 transition-all duration-300" style={{ animationDelay: `${index * 0.1}s` }}>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Keep our servers running 24/7 for global access</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Fund development of exciting new capabilities</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Support marketing to help more people discover Smart Budget</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Guarantee Smart Budget stays free and open forever</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="glass-card border-0 shadow-premium">
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl border border-green-200 dark:border-green-800">
                  <h4 className="font-bold text-green-800 dark:text-green-200 mb-2">✅ Always Free</h4>
                  <p className="text-sm text-green-700 dark:text-green-300">No subscriptions, no premium tiers, no hidden costs - ever!</p>
                </div>
                <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                  <h4 className="font-bold text-blue-800 dark:text-blue-200 mb-2">🔓 Open Source</h4>
                  <p className="text-sm text-blue-700 dark:text-blue-300">Full transparency - inspect our code on GitHub</p>
                </div>
                <div className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl border border-purple-200 dark:border-purple-800">
                  <h4 className="font-bold text-purple-800 dark:text-purple-200 mb-2">🌍 Global Access</h4>
                  <p className="text-sm text-purple-700 dark:text-purple-300">Available worldwide to anyone who needs it</p>
                </div>
                <div className="p-4 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-xl border border-orange-200 dark:border-orange-800">
                  <h4 className="font-bold text-orange-800 dark:text-orange-200 mb-2">🔒 Privacy First</h4>
                  <p className="text-sm text-orange-700 dark:text-orange-300">Your data stays yours - no tracking, no selling</p>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="glass-card border-0 shadow-premium mb-16">
            <CardHeader className="text-center">
              ...
              <p className="text-lg text-muted-foreground">
                Support Smart Budget with cryptocurrency donations. Every contribution helps keep us free and open source!
              </p>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-4">
                      <div className={`w-16 h-16 bg-gradient-to-r ${wallet.bgColor} rounded-2xl flex items-center justify-center text-white text-2xl font-bold shadow-lg`}>
                        {wallet.icon}
                      </div>
                      <div>
                        <h3 className="text-2xl font-bold text-foreground">{wallet.type}</h3>
                  ...
                  <p className="text-center text-sm text-muted-foreground mt-3 font-medium">
                    Send {wallet.type} to this address to support Smart Budget development
                  </p>
                </div>
              ))}
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-yellow-100 via-orange-100 to-red-100 dark:from-yellow-900/30 dark:via-orange-900/30 dark:to-red-900/30 rounded-2xl border-2 border-yellow-300 dark:border-yellow-700 text-center">
                ...
                <p className="text-lg text-yellow-700 dark:text-yellow-300">
                  Every donation, no matter the size, helps keep Smart Budget free and accessible to everyone worldwide. 
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Give us a star to help others discover Smart Budget</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Tell friends and family about Smart Budget</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Help us build new features and fix bugs</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="glass-card border-0 shadow-premium">
              ...
              <CardContent className="space-y-4">
                ...
                <Button 
                  ...
                  onClick={() => window.open('https://github.com/BuilderIO/fusion-starter', '_blank')}
                >
